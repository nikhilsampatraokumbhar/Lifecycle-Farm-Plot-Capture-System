...
|---|---|---|
| **Season 1** | Onboarding, sowing and post-harvest. One district, twenty technicians, four thousand farmers. Flags are recorded and reviewed but hold nothing up | That the area gap is real, measurable and closing, and that technicians are still using it properly in month four |
...
**The baseline turns out to be wrong.** Everything sits on the onboarding walk, so one bad capture spoils a farmer's whole season. Mitigated by stricter onboarding rules, the same supervisor sample, and a path to re-measure a farm.

**The office does not act on the flags.** This is the one people miss. If he adds a photo, a reason and a note and nothing visibly happens, he learns careful work goes nowhere. The flag queue needs a named owner from week one, and **he needs to see what happened to the ones he raised.**
